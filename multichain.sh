...
su -l $username -c  "multichain-cli "$chainname" issue "$addr" '{\"name\":\""$assetName"\", \"open\":true}' 1000000000000 1.0 0 '{\"description\":\"These assets represent votes from individuals.\"}'"
